...
export function Nav() {
  ...
  return (
    <Navbar  className=" fixed z-[100] shadow-lg w-full px-5" fluid>
      ...
      <DropdownItem><NavLink to='/TopRatedMovies'>Top Rated</NavLink></DropdownItem>
    </Dropdown>
          
        <NavbarLink><NavLink to='/Tv'>Tv</NavLink></NavbarLink>
