...
export default function TvShowCastandCrew() {
  const { id } = useParams()
  const {cast,crews,isLoading,directing,Art,Sound,Writing,Production,Crew,Camera,CostumeAndMake_Up,Editing,VisualEffects} = useTvShowCastAndCrew(id) 
