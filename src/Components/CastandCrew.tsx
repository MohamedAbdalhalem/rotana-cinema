...
import useCastAndCrew from "../Hooks/useCastAndCrew"
...
export default function CastandCrew() {
  const { id } = useParams()
  const {cast,crews,isLoading,directing,Art,Sound,Writing,Production,Crew,Camera,CostumeAndMake_Up,Editing,VisualEffects} = useCastAndCrew(id) 
