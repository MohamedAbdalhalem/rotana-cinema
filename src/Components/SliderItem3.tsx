...
export default function SliderItem3({movieData} : {movieData : movieType}) {
  return (
    <div className="px-2">
  <Link to={`/movieDetials/${movieData.id}/overview`} className="relative h-[600px] md:h-[500px]  mb-2 rounded-2xl bg-white dark:bg-gray-900 shadow-lg overflow-hidden  flex flex-col flex-grow">
